...
export const homePageStyles = {
  alertChips: 'flex rounded-md text-base font-normal px-4 py-2 bg-white-14 border border-input',
  domainInsightsCard: 'min-w-72 min-h-60 rounded-md mb-7 me-7 bg-white-14 border border-input',
}
