...
export const ownersList = ['John Doe', 'Jane Smith', 'Admin', 'User1', 'User2']
export const mimeTypes = [
  ...
  { value: 'application/vnd.google-apps.drive-sdk', label: 'Drive SDK' },
  ...
  { value: 'application/vnd.google-apps.script', label: 'Google Apps Script' },
  // Add other MIME types as needed from the provided link
]
