        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : 'group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=left]:border-sidebar-accent group-data-[side=right]:border-l',
            className
          )}
          {...props}
        >
