  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: 'space-y-4 p-3 border border-foreground/10 rounded-lg shadow',
        caption: 'flex justify-center pt-1 relative items-center',
        caption_label: 'text-sm font-medium',
        nav: 'space-x-1 flex items-center',
        nav_button: cn(
          buttonVariants({ variant: 'carousel', size: 'sm' }),
          'h-7 w-7 border-foreground/30 bg-transparent p-0 opacity-50 hover:opacity-100'
        ),
